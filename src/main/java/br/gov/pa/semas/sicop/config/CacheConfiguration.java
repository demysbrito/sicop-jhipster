...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.gov.pa.semas.sicop.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.gov.pa.semas.sicop.repository.UserRepository.USERS_BY_EMAIL_CACHE);
