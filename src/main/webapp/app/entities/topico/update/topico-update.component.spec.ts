...
describe('Topico Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Ajuda query and add missing value', () => {
      ...
      const ajudas: IAjuda[] = [{ id: '3b92a931-488b-4680-9d39-8a095354f000' }];
      topico.ajudas = ajudas;

      const ajudaCollection: IAjuda[] = [{ id: '93c20818-450d-4ec4-9fb7-f0c50a6363d0' }];
    ...
    it('Should call Assunto query and add missing value', () => {
      const topico: ITopico = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const assuntos: IAssunto[] = [{ id: 30097 }];
      topico.assuntos = assuntos;

      const assuntoCollection: IAssunto[] = [{ id: 28713 }];
    ...
    it('Should update editForm', () => {
      const topico: ITopico = { id: '1361f429-3817-4123-8ee3-fdf8943310b2' };
      const ajudas: IAjuda = { id: '5401a6ca-c55b-4567-ac5d-53026261c3db' };
      topico.ajudas = [ajudas];
      const assuntos: IAssunto = { id: 15283 };
      topico.assuntos = [assuntos];
