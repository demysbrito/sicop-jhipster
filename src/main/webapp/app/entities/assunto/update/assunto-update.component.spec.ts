...
describe('Assunto Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Topico query and add missing value', () => {
      ...
      const topicos: ITopico[] = [{ id: '4ec50e56-22c6-468b-a432-a80e12657a54' }];
      assunto.topicos = topicos;

      const topicoCollection: ITopico[] = [{ id: 'f6fffb1a-3874-47d3-bcfa-0deaa7261e52' }];
    ...
    it('Should update editForm', () => {
      const assunto: IAssunto = { id: 456 };
      const topicos: ITopico = { id: 'e72adf27-7f41-49bb-a127-198156bf0aee' };
      assunto.topicos = [topicos];
