...
describe('Usuario Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Perfil query and add missing value', () => {
      ...
      const perfil: IPerfil = { id: 11062 };
      usuario.perfil = perfil;

      const perfilCollection: IPerfil[] = [{ id: 6679 }];
    ...
    it('Should call Setor query and add missing value', () => {
      const usuario: IUsuario = { id: 456 };
      const setor: ISetor = { id: 26135 };
      usuario.setor = setor;

      const setorCollection: ISetor[] = [{ id: 25224 }];
    ...
    it('Should update editForm', () => {
      const usuario: IUsuario = { id: 456 };
      const perfil: IPerfil = { id: 1107 };
      usuario.perfil = perfil;
      const setor: ISetor = { id: 18015 };
      usuario.setor = setor;
