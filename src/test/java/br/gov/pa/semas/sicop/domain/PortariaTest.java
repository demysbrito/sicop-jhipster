...
import static br.gov.pa.semas.sicop.domain.PortariaTestSamples.*;
import static br.gov.pa.semas.sicop.domain.SetorTestSamples.*;
import static br.gov.pa.semas.sicop.domain.UsuarioTestSamples.*;
