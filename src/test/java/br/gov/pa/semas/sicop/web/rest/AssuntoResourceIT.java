...
import static br.gov.pa.semas.sicop.domain.AssuntoAsserts.*;
...
import br.gov.pa.semas.sicop.repository.AssuntoRepository;
...
class AssuntoResourceIT {
    ...
    void partialUpdateAssuntoWithPatch() throws Exception {
        ...
        partialUpdatedAssunto.nome(UPDATED_NOME).deletedAt(UPDATED_DELETED_AT);
