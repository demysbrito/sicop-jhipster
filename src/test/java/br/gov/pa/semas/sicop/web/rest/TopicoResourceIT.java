...
import static br.gov.pa.semas.sicop.domain.TopicoAsserts.*;
import static br.gov.pa.semas.sicop.web.rest.TestUtil.createUpdateProxyForBean;
import static br.gov.pa.semas.sicop.web.rest.TestUtil.sameInstant;
...
import br.gov.pa.semas.sicop.repository.TopicoRepository;
...
class TopicoResourceIT {
    ...
    void partialUpdateTopicoWithPatch() throws Exception {
        ...
        partialUpdatedTopico.titulo(UPDATED_TITULO).conteudo(UPDATED_CONTEUDO).ativo(UPDATED_ATIVO).updatedAt(UPDATED_UPDATED_AT);
