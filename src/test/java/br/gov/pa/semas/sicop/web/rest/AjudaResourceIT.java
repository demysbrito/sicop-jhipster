...
import static br.gov.pa.semas.sicop.domain.AjudaAsserts.*;
...
import br.gov.pa.semas.sicop.repository.AjudaRepository;
...
class AjudaResourceIT {
    ...
    void partialUpdateAjudaWithPatch() throws Exception {
        ...
        partialUpdatedAjuda.updatedAt(UPDATED_UPDATED_AT).deletedAt(UPDATED_DELETED_AT);
